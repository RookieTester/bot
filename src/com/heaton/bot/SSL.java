...
/**
 * The SSL class is used to provide an interface to JSSE without making the
 * entire package dependant on JSSE being installed.
 *
 * @author Jeff Heaton
 * @version 1.2
 */
public class SSL {
	...
	/**
	 * A factory used to create SSL sockets from. This factory is created when
	 * the class is first loaded and reused for each new socket.
	 */
	protected static SSLSocketFactory factory = null;

	/**
	 * This method is called to get an SSL client socket for the specified host
	 * and port.
	 *
	 * @param host
